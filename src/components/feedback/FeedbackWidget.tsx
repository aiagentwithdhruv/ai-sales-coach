  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          ref={panelRef}
          className="fixed bottom-[8.5rem] right-4 z-50 w-[380px] max-w-[calc(100vw-2rem)] h-[520px] max-h-[60vh] rounded-2xl bg-graphite border border-gunmetal shadow-2xl shadow-black/60 overflow-hidden flex flex-col"
      ...
      <button
        onClick={handleToggle}
        className="fixed bottom-[4.5rem] right-5 z-50 group"
